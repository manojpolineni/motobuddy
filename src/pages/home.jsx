...
return(
  <Page name="home" style={{"background-color":"silver"}}>
    ...
    <Navbar large sliding={false}>
      ...
      <NavRight>
        <Button href="#" className="list">Home</Button>
        <Button className="list"><a href='/my vehicles/'>My Vehicles</a></Button>
        <Button className="list" onClick={userlist}>Bookings</Button>
        <Button className="list">Coupons</Button>
        <Button className="list">Gear</Button>
        <Button className="list">Accessories</Button>
        {/* <Button className="list" onClick={userlist}>Bookings</Button> */}
        {/* <Button className="list"><a href='/profile/'>Profile</a></Button> */}
        <MenuItem  className="Menu" text="Profile" dropdown>
        <MenuDropdown  className="Menu-text1">
          <MenuDropdownItem href="/bookings/" className="menu-text" text="My Bookings" />
          <MenuDropdownItem href="/profile/"className="menu-text" text="Profile" />
          <MenuDropdownItem href="#" className="menu-text" text="Account" />
          <MenuDropdownItem href="#" className="menu-text" text="Log Out" />
    ...
    <Block>
      ...
      <SwiperSlide><p>
      <div class="carousel">
      <img data-src="static/icons/service1.jpg" width= "1800" height= "700" 
            class="lazy lazy-fade-in demo-lazy" />
            </div>
        </p></SwiperSlide>
      <SwiperSlide><p>
      <div class="carousel">
      <img data-src="static/icons/service2.jpg" width = "1800" height= "700"
            class="lazy lazy-fade-in demo-lazy" />
            </div>
        </p></SwiperSlide>
      <SwiperSlide><p>
      <div class="carousel">
      <img data-src="static/icons/service3.jpg" width= "1800" height= "700" 
            class="lazy lazy-fade-in demo-lazy" />
            </div>
